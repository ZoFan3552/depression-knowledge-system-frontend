import { Disease, Symptom, Risk, Therapy, Medication } from "@/types/depression";
...
// 类型守卫函数，用于判断实体类型
const isDisease = (entity: any): entity is Disease => 'medicalCode' in entity || 'diagnosticCriteria' in entity;
const isSymptom = (entity: any): entity is Symptom => 'severity' in entity || 'isCommon' in entity;
const isRisk = (entity: any): entity is Risk => 'impactFactor' in entity || 'evidenceLevel' in entity;
const isTherapy = (entity: any): entity is Therapy => 'approach' in entity || 'durationCourse' in entity;
const isMedication = (entity: any): entity is Medication => 'genericName' in entity || 'drugClass' in entity;
 ...
 */
export function entityToNode(entity: Disease | Symptom | Risk | Therapy | Medication): GraphNode {
 ...
 */
export function generateGraphFromDisease(disease: Disease): { nodes: GraphNode[], links: GraphLink[] } {
...
export function generateCompleteGraph(
  entityArrays: Array<Disease[] | Symptom[] | Risk[] | Therapy[] | Medication[]>
