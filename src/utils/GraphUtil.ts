...
const RELATION_CONFIGS: readonly RelationConfig[] = [
    { key: 'symptoms', type: 'Symptom', color: NodeColor.SYMPTOM, relationText: 'HAS_SYMPTOM' },
    { key: 'causes', type: 'Cause', color: NodeColor.CAUSE, relationText: 'HAS_CAUSE' },
    { key: 'diagnoses', type: 'Diagnosis', color: NodeColor.DIAGNOSIS, relationText: 'HAS_DIAGNOSIS' },
    { key: 'treatments', type: 'Treatment', color: NodeColor.TREATMENT, relationText: 'HAS_TREATMENT' },
    { key: 'preventions', type: 'Prevention', color: NodeColor.PREVENTION, relationText: 'HAS_PREVENTION' },
    { key: 'medications', type: 'Medication', color: NodeColor.MEDICATION, relationText: 'HAS_MEDICATION' },
] as const;

export function convertDepressionArrayToGraph(
